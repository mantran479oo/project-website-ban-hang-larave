        ...
        <ul class="nav">
          <li class="nav-item active  ">
            <a class="nav-link" href="{{ route('admin.index') }}">
              <i class="material-icons">Trang chủ</i>
              <p>Trang chủ</p>
            </a>
          </li>
          <li class="nav-item ">
        ...
        <!--   <li class="nav-item ">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="./map.html">
              ...
              <p>Địa điểm của hàng</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="./notifications.html">
              <i class="material-icons">Thêm sản phẩm mới</i>
...
@yield('noidung')
  ...
  <script src="{{asset('adminjs/material-dashboard.js?v=2.1.2')}}" type="text/javascript"></script>
