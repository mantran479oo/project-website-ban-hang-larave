		...
		<div id="content">
			...
			<div class="row">
				<div class="col-sm-6 wow fadeInLeft">
					<div class="beta-person media">
						...
						<img class="pull-left" src="{{asset('images/person2.jpg')}}" alt="">
				...
				<div class="col-sm-6 wow fadeInRight">
					<div class="beta-person media ">
						...
						<img class="pull-left" src="{{asset('images/person3.jpg')}}" alt="">
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="beta-person beta-person-full">
					<div class="bets-img-hover">
						<img src="{{asset('images/person2.jpg')}}" alt="">
					</div>
						<div class="beta-person-body">
							<h5>Bob Robertson</h5>
							<p class="font-large">Web developer</p>
				...
				<div class="col-sm-3">
					<div class="beta-person beta-person-full">
					<div class="bets-img-hover">
						<img src="{{asset('images/person3.jpg')}}" alt="">
					</div>
						<div class="beta-person-body">
							<h5>Mike Greenwood</h5>
							<p class="font-large">Web developer</p>
